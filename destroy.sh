...
export TF_VAR_foundryvtt_docker_image=jobrown/foundryvtt:10.303.0
...
terraform destroy --auto-approve -target=module.foundry_server.aws_lb_listener.foundry_server_ssh
terraform destroy --auto-approve -target=module.foundry_server.aws_lb_target_group.lb_foundry_server_https
terraform destroy --auto-approve -target=module.foundry_server.aws_lb_target_group.lb_foundry_server_ssh
...
terraform destroy --auto-approve -target=module.foundry_server.aws_security_group_rule.lb_allow_inbound_22
